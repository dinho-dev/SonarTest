    ...
    },
    {
      ...
      ejemplos: [
        ...
        },
        {
          titulo: "Text Spacing",
          descripcion:
            "The letter-spacing property is used to add or subtract space between the letters that make up a word. The letter-spacing property is specified in pixels or em values.",
        },
      ],
    },
  ];